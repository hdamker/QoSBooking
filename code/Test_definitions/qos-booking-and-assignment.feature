Feature: CAMARA QoS Booking and Assignment - v0.1rc1
    ...
    Scenario: Create a QoS booking with valid parameters
        ...
        And the response body property "$.status" is set to a value complaint with schema at "/components/schemas/Status"
        And the response body property "$.status" is set to a value "SUCCESSFUL"
        And the response body property "$.statusInfo" is optional, if present, is set to a value complaint with "/components/schemas/BookingStatusInfo"
        And the response body property "$.statusSource" is optional, if present, is set to a value complaint with "/components/schemas/StatusSource"
    ...
    # Success scenarios for POST /devices/{bookingID}/assign
    ...
    Scenario: Assign a set of devices to a QoS booking
        ...
        Given the resource "{apiRoot}/qos-booking-and-assignment/v0.1rc1/devices/{bookingId}/assign"
        ...
        And the request body property "$.devices" is set to a valid array of device identifiers set to a value complaint with schema at "/components/schemas/Devices"
        And the request body property "$.sink" is set to a valid notification URL
        And the request body property "$.sinkCredential.credentialType" is set to a value complaint with schema at "/components/schemas/SinkCredential"
        ...
        And the response body property "$.bookingDetails" is optional, if present, is set to a value complaint with schema at "/components/schemas/BookingDetails"
        And the response body property "$.devices" exists and should have atleast one device identifier a value complaint with schema at "/components/schemas/Devices"
        ...
        And the response body property "$.status" is set to a value complaint with schema at "/components/schemas/Status"
        And the response body property "$.status" is set to a value "SUCCESSFUL"
        And the response body property "$.statusInfo" is optional, if present, is set to a value complaint with "/components/schemas/AssignmentStatusInfo"
        And the response body property "$.statusSource" is optional, if present, is set to a value complaint with "/components/schemas/StatusSource"

    # Success scenarios for POST /devices/{bookingID}/release
    ...
    Scenario: Release one or more of already assigned devices from a QoS booking
        ...
        Given the resource "{apiRoot}/qos-booking-and-assignment/v0.1rc1/devices/{bookingId}/release"
        And the "bookingId" is created by operation "createBooking"
        ...
        And the response body complies with the OAS schema at "/components/schemas/DeviceAssignmentOutput"
        And the response body property "$.bookingDetails" is optional, if present, is set to a value complaint with schema at "/components/schemas/BookingDetails"
        And the response body property "$.devices" is set to a value complaint with schema at "/components/schemas/Devices"
        And the response body property "$.devices" is a set of device identifiers that are actually released from booking
        And the response body property "$.status" is set to a value complaint with schema at "/components/schemas/Status"
        And the response body property "$.status" is set to a value "SUCCESSFUL"
        And the response body property "$.statusInfo" is optional, if present, is set to a value complaint with "/components/schemas/AssignmentStatusInfo"
        And the response body property "$.statusSource" is optional, if present, is set to a value complaint with "/components/schemas/StatusSource"

    # Success scenarios for GET /devices/{bookingID}
    ...
    Scenario: Get a list of devices assigned to a QoS booking
        ...
        Given the resource "{apiRoot}/qos-booking-and-assignment/v0.1rc1/devices/{bookingId}"
        And the "bookingId" is created by operation "createBooking"
    ...
    Scenario: Get QoS Booking resource information details for a device
        ...
        And the resource "/devices/retrieve"
